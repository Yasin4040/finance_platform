 ...
 * @author Admin
 */
@TableName(value = "budget_unit_month_report")
@Data
public class BudgetUnitMonthReport implements Serializable {
     ...
     */
    @ApiParam(hidden = true)
    @TableField(value = "ownsubjectflag")
    private Boolean ownsubjectflag;
