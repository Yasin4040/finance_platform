 ...
 * @author Admin
 */
@TableName(value = "budget_year_subject_for_oa")
@Data
public class BudgetYearSubjectForOa implements Serializable {
    ...
    @NotNull(message = "年度执行金额不能为空")
    @ApiParam(hidden = true)
    @TableField(value = "yizhixingmoney")
    private BigDecimal yizhixingmoney;
